...
class Test_UtilityOutcome_QOL:
    ...
    @pytest.mark.C26938
    def test_qol_utility_outcome_sorting_order_newimport_logic(self, extra):
        # Creating object of loginpage class
        self.loginPage = LoginPage(self.driver, extra)
        # Creating object of liveslrpage class
        self.liveslrpage = LiveSLRPage(self.driver, extra)
        ...
        for i in self.pop_list:
            try:
                ...
                for j in self.slrtype:
                    ...
                    self.utiloutcome.qol_verify_utility_summary_sorting_order(excel_filename1, self.util_filepath)
