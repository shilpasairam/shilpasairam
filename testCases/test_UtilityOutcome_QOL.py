...
class Test_UtilityOutcome_QOL:
    ...
    def test_qol_presenceof_utility_outcome(self, extra):
        ...
        for i in self.pop_list:
            try:
                ...
                for j in self.slrtype:
                    ...
                    self.utiloutcome.qol_presenceof_utility_summary_tab(excel_filename1, self.util_filepath)

            except Exception:
                raise Exception("Unable to select element")

    def test_qol_utility_outcome_results_comparison(self, extra):
        # Creating object of loginpage class
        self.loginPage = LoginPage(self.driver, extra)
        # Creating object of liveslrpage class
        self.liveslrpage = LiveSLRPage(self.driver, extra)
