...
class Test_Login:
    ...
    def test_portal_contact_info(self, extra, env, request, caseid):
        ...
        if actual_contact_info == expected_contact_info:
            ...
            LogScreenshot.fLogScreenshot(message=f"Mismatch found in Cytel company address on Contact page. Expected Contact address is: {expected_contact_info} and Actual Contact address is: {actual_contact_info}",
