...
class LiveRef_Rebrand(Base):
    ...
    def validate_liveref_rebrand(self, TestData):

        user_role = self.get_text("user_role")
        ...
        title_bar_txt = self.get_text("title_bar")
        ...
        about_liveref_txt = self.get_text("about_live_ref")
        ...
        liveref_insights_txt = self.get_text("dashboard_insights")
        ...
        liveref_updates_txt = self.get_text("dashboard_updates")
        ...
        self.go_to_page("searchpublications_button")
        self.click("sourceofdata_section")
        src_updates_txt = self.get_text("sourceofdata_allupdates_btn")
        ...
        src_param_header = self.get_text("selected_src_param_head")
        ...
        src_param_body = self.get_text("selected_src_param_body")
        ...
        self.click("cat_of_evidence_section")
        cat_evidence_txt = self.get_text("cat_of_evidence_section")
        ...
        cat_evi_placeholder_txt = self.select_element("cat_of_evidence_placeholder").get_attribute("placeholder")
        ...
        cat_evi_param_header = self.get_text("selected_cat_param_head")
        ...
        cat_evi_param_body = self.get_text("selected_cat_param_body")
        ...
        self.click("reported_cols_sections", UnivWaitFor=10)
        time.sleep(2)
        rpt_col_src_data = self.get_text("reported_col_sourcedata")
        ...
        rpt_col_short_ref = self.get_text("reported_col_shortref")
        ...
        rpt_col_qual_sum = self.get_text("reported_col_qualsummary")
        ...
        rpt_col_evi_cat = self.get_text("reported_col_evicat")
        ...
        rpt_col_subcat = self.get_text("reported_col_subcat")
        ...
        rpt_col_pubdetails = self.get_text("reported_col_pubdetails")
        ...
        rpt_col_reportedvar = self.get_text("reported_col_reportedvar")
        ...
        rpt_col_additional_details = self.get_text("reported_col_additionaldetails")
        ...
        rpt_col_quant_results = self.get_text("reported_col_quantresults")
        ...
        excel_name = self.srchpub.validate_downloaded_filename('scenario1', TestData)
        ...
        self.go_to_page("managesourcedata_button")
        src_data_page_link_text = self.get_text("managesourcedata_button")
        ...
        src_data_page_name = self.get_text("managesourcedata_pagename")
        ...
        add_src_data_btn_txt = self.get_text("add_sourcedata_btn")
        ...
        self.click("add_sourcedata_btn")                              
        add_src_data_form_label = self.get_text("mngsrc_form_label")
        ...
        src_form_name = self.get_text("mngsrc_form_name")
        ...
        src_form_abbreviation = self.get_text("mngsrc_form_abbreviation")
        ...
        src_form_short_code = self.get_text("mngsrc_form_short_code")
        ...
        src_form_startdate = self.get_text("mngsrc_form_startdate")
        ...
        src_form_enddate = self.get_text("mngsrc_form_enddate")
        ...
        src_form_logo = self.get_text("mngsrc_form_logo")
        ...
        src_data_table_heading = self.get_text("mngsrc_table_heading")
        ...
        src_table_logo = self.get_text("mngsrc_table_sourcelogo_col")
        ...
        src_table_name = self.get_text("mngsrc_table_sourcename_col")
        ...
        src_table_shortcode = self.get_text("mngsrc_table_sourceshrtcode_col")
        ...
        self.go_to_page("liveref_managecatevidence_button")
        cat_evidence_page_link_txt = self.get_text("liveref_managecatevidence_button")
        ...
        cat_evidence_page_name = self.get_text("liveref_managecatevidence_pagename")
        ...
        add_cat_evidence_btn_txt = self.get_text("add_catevidence_button")
        ...
        self.click("add_catevidence_button")                              
        add_cat_evidence_form_label = self.get_text("mngcatevidence_form_label")
        ...
        add_cat_evidenceform_name = self.get_text("mngcatevidence_form_name")
        ...
        cat_evidence_table_heading = self.get_text("mngcatevidence_table_heading")
        ...
        self.go_to_page("liveref_importpublications_button")
        import_pub_page_name = self.get_text("liveref_importpublications_pagename")
        ...
        import_pub_download_label = self.get_text("importpublications_fieldtext_download")
        ...
        ele1 = self.select_element("importpub_select_dropdown")
        ...
        import_pub_upload_label = self.get_text("importpublications_fieldtext_upload")
        ...
        ele2 = self.select_element("importpub_upload_dropdown")
        ...
        import_pub_bullet_txt = self.get_text("importpub_bullet1_text")
